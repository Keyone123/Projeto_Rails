...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference("Tarefa.count") do
      post tarefas_url, params: { tarefa: { data: @tarefa.data, descrição: @tarefa.descrição, nome: @tarefa.nome } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { data: @tarefa.data, descrição: @tarefa.descrição, nome: @tarefa.nome } }
